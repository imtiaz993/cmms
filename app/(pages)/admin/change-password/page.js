...
const Profile = () => {
  ...
  return (
    <>
      ...
      <div className="max-h-[calc(100dvh-76px)] overflow-auto px-5 lg:px-10 py-5">
          ...
          <div className="flex justify-between mb-10 lg:mb-16">
            <div>
              ...
              <p className="text-sm max-w-[500px]">
                Update your password here for enhanced security. Keep your
                account safe by changing it whenever you feel it&apos;s
                necessary!
              </p>
            </div>
          </div>
